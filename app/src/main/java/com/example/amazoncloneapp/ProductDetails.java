...
public class ProductDetails extends AppCompatActivity {
    ...
    TextView productName,productPrice,productDesc,productCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName = findViewById(R.id.product_price);
...
//            Toast.makeText(this, "In correct block", Toast.LENGTH_SHORT).show();
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User View").child(auth.getCurrentUser().getUid()).
                child("Products").child(uniqueId).updateChildren(cartMap)
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AddProdModel, RelatedProductsHolder> adapater = new FirebaseRecyclerAdapter<AddProdModel, RelatedProductsHolder>(options) {
            @Override
        ...
        related_prod_list.setAdapter(adapater);
