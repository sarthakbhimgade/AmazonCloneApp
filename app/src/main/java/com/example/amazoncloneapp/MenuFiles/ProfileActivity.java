...
public class ProfileActivity extends BaseActivity {
    ...
    TextView profileEmail,profileHistory,profileLogout,displayUsername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = database.getReference().child(auth.getCurrentUser().getUid());
        ...
        profileImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(setImageUri!=null){
                    ...
                    String imgUri = "https://firebasestorage.googleapis.com/v0/b/cloneapp-122ef.appspot.com/o/profilepicicon.jpg?alt=media&token=e6aa4843-3676-484b-a129-0b2076fb01f0" ;
